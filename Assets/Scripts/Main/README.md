...
* Assets/Scripts/Main/Domain/[ContextName]/IHogeRepository.cs
    * [サンプルコード](./Domain/Player/IPlayerRepository.cs)
...
* Assets/Scripts/Main/UseCase/[ContextName]/HogeUseCase.cs
    * [サンプルコード](./UseCase/Player/RenamePlayerUseCase.cs)
* Assets/Scripts/Main/UseCase/ApplicationError.cs
    * [サンプルコード](./UseCase/ApplicationError.cs)
    * アプリケーション層で発生したエラー情報
* Assets/Scripts/Main/UseCase/ApplicationResult.cs
    * [サンプルコード](./UseCase/ApplicationResult.cs)
    * アプリケーション層の処理結果
* Assets/Scripts/Main/UseCase/IUseCase.cs
    * [サンプルコード](./UseCase/IUseCase.cs)
    * ユースケース interface